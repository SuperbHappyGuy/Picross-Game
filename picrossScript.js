...
function scale() {
  for(let i = 2; i <= 20; i++) {
    ...
    if(userInput == 2) {
      document.getElementById("grid").style.zoom = 0.85;
    }
    if(userInput == 3) {
      document.getElementById("grid").style.zoom = 0.70;
    }
    if(userInput == 4) {
      document.getElementById("grid").style.zoom = 0.55;
    }
    if(userInput == 5) {
      document.getElementById("grid").style.zoom = 0.50;
    }
    if(userInput == 6) {
    ...
    if(userInput == 8) {
      document.getElementById("grid").style.zoom = 0.35;
    }
    if(userInput == 9) {
      document.getElementById("grid").style.zoom = 0.35;
    }
    ...
    if(userInput == 15) {
      document.getElementById("grid").style.zoom = 0.24;
    }
    if(userInput == 16) {
